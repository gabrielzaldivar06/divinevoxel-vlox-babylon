 ...
 */
export declare const SharedVoxelAttributes: {
    readonly DissolutionProximity: "dissolutionProximity";
    readonly PullStrength: "pullStrength";
    readonly SubdivLevel: "subdivLevel";
    readonly PullDirectionBias: "pullDirectionBias";
    readonly PhNormalized: "phNormalized";
    readonly SubdivAO: "subdivAO";
};
